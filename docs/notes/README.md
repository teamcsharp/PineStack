...
- [A meter that cannot fail](a-meter-that-cannot-fail.md) — a check built out of the thing it is checking always passes; the 2026-09-13 worked example, where three clean counters sat over a document that was 49% unplaced
- [The bind underneath the mount](the-bind-underneath-the-mount.md) — 2026-09-14: /samples empty inside the container while full on the host (stale rprivate bind: dev-id tell, recreate not restart); the clip book (#1362) and the clip doctor (#1361); the ARP ceiling that stopped the camera joining (#1359); and the census that showed 93% of the dead air was a blocked loop, not a thin script (#1368, cured by #1370-#1372)
- [The loop under the profile](the-loop-under-the-profile.md) — 2026-09-14: py-spy on uvicorn's own pid from the host; a failed `import sniffio` on every httpx request, a lock shared with a desk thread, a call log parsed per read, and the collector's report — what 20 s of samples said and what each cure changed
- [Continuity investigation 2026-09-14](continuity-investigation-2026-09-14.md) — #1390/#1396/#1397/#1400/#1401/#1407/#1408: the hour was empty because the preparer's output was pinned to dead slots and the 89 MB catalogue held the GIL; a 684 MB store was json.dumps-ed whole; the page turned every stall into silence; the census named bystanders, py-spy named the holders; the 30-min reading after
