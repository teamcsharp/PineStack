...
const THREEJS_VIEWS = [
  ...
  { key: "rapassembly", icon: "🎛", name: "RapAssembly", since: "2026-09-08",
    systems: "three.min.js · /api/rapassembly · the pipeline diary",
    what: "The assembly line, live: a thought to a rhymed line on the air",
    desc: "Ten stations in a row - ideation, the writing room, the crystal, the tint, the grader, the recording room, the stores, the schedule, the air, the learning - lit by their live numbers, with packets travelling the hand-offs as asks, verdicts, renders, lines and covers land. The rail carries every number and the last diary lines; docs/RapAssembly.md is the written account." },
  ...
  { key: "journal", icon: "📖", name: "Request book", since: "#1079",
    systems: "three.module.js · /api/pine-journal · data/pine_journal/*.md",
    what: "Every request and its reply, page by page",
    desc: "One page per resolved request: the request, the reply as it was written, the token costs in and out, and the work as a flow chart — the reply's sections and steps as glowing nodes you can turn, zoom and click to jump to the passage." },
