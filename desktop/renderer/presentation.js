...
(function (root) {
  ...
  function build(target) {
    target.innerHTML =
      ...
      + '<button id="pvPrev" class="pv-mini" title="Put the last record back and cut to it">|&lt;</button>'
      + '<button id="pvNext" class="pv-mini" title="Skip to the next record now">&gt;|</button>'
